...
const Form = ({block}) => {
  ...
  //   e.preventDefault();
  //   const call= await chatSession.sendMessage("name of president of india");
    ...
    <div style={(block)?{display:"block",position:"none"}:{display:"none"}} id='form'  >
     <form style={{position:"absolute"}}>
      ...
      <hr id='hr1' style={{width:"36vw"}} />
        <label htmlFor="name">Enter Name</label><input style={{border:"1px solid black"}} type="text" required onChange={(e)=>setname(e.target.value)} placeholder='EX- XYZ' /><br />
